"""Fetch headlines and turn them into a structured sentiment signal."""
...
SCORING_SYSTEM_PROMPT = """You are a macro/gold-market analyst. You will be given a list of recent news headlines and short descriptions. For each one, assess its likely impact on the price of gold (XAU/USD).

Respond ONLY with a JSON array (no preamble, no markdown fences), where each element has this exact shape:
{
...
Guidelines:
- Geopolitical tension/war/crisis -> typically bullish
- Hawkish Fed / rising real rates -> typically bearish
